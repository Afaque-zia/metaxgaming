!(function (e) {
      ...
      return this.each(function () {
        ...
        s.find("li").each(function () {
          ...
          s.addClass(t.subMenuClass),
            ...
            s.prev("a").addClass(t.meanExpandClass),
            s.next("a").addClass(t.meanExpandClass);
        });
        ...
        e(n).each(function () {
          e(this).on("click", function (s) {
            var a;
            s.preventDefault(),
              e((a = this)).next("ul").length > 0
                ? (e(a).parent().toggleClass(t.subMenuParentToggle),
                  e(a).next("ul").slideToggle(t.toggleSpeed),
                  e(a).next("ul").toggleClass(t.subMenuToggleClass))
                : e(a).prev("ul").length > 0 &&
                  (e(a).parent().toggleClass(t.subMenuParentToggle),
                  e(a).prev("ul").slideToggle(t.toggleSpeed),
                  e(a).prev("ul").toggleClass(t.subMenuToggleClass));
          });
        }),
  ...
  e(window).on("scroll", function () {
    ...
    (t = e(".sticky-active")),
      ...
      e(window).scrollTop() > 800
        ? (t.parent().addClass(n), i > s ? t.removeClass(a) : t.addClass(a))
  ...
  i
    ...
    e(".recent-post-tab").length &&
      e(".recent-post-tab").vsTab({ sliderTab: !0, tabButton: ".nav-link" }),
    SmoothScroll({
      animationTime: 1e3,
      stepSize: 100,
    ...
    e("[data-ani]").each(function () {
      ...
      e(this).addClass(s),
        e(".slick-current [data-ani]").addClass("vs-animated");
    }),
    e(".vs-carousel").on("afterChange", function (s, t, a, n) {
      e(t.$slides).find("[data-ani]").removeClass("vs-animated"),
        e(t.$slides[a]).find("[data-ani]").addClass("vs-animated");
    }),
